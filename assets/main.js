Vue.createApp({
  ...
  methods: {
    ambilArticle()
    {
      axios
        .get(
          "https://raw.githubusercontent.com/AbdurrahmanThariq/tekweb2022/main/artikel/artikel.json"
          )
        .then((res) => {
    ...
    ambilDataMarkdown()
    {
      ...
      axios
        .get(
          "https://raw.githubusercontent.com/AbdurrahmanThariq/tekweb2022/main/artikel/"+artikel
        )
        .then((res) => {
